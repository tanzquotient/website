...
RUN apt-get update && apt-get install -y --force-yes gettext python-virtualenv python-pip libmysqlclient-dev python-dev gcc gcc-multilib rabbitmq-server libjpeg-dev git
