...
def problem_add_handler(sender, **kwargs):
    ...
    send_mail(u'Problem occurred in TQ System', u'A problem occurred in TQ System. Please check what the problem was, in Admin area -> Audit section -> Problem.\n\nTag: {}\nMessage:\n{}\n'.format(problem.tag, problem.message), my_settings.EMAIL_HOST_USER,
