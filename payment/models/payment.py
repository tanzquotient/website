...
class Payment(models.Model):
    ...
    amount_to_reimburse = models.DecimalField(
        blank=True, default=0, decimal_places=2, max_digits=9
    )
    ...
    def __str__(self):
        return "Payment ({}) of {} by {}".format(
            self.credit_debit, self.amount, self.name
        )
