...
@override_settings(
    FDS_PRIVATE_KEY=os.path.join(settings.BASE_DIR, "test_config", "keys", "test_keys")
)
@override_settings(
    FDS_HOST_KEY=os.path.join(settings.BASE_DIR, "test_config", "keys", "test_keys.pub")
)
@override_settings(
    FDS_DATA_PATH=os.path.join(
        settings.BASE_DIR, "test_config", "downloaded_data_files"
    )
)
