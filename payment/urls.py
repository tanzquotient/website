...
urlpatterns = [
    ...
    path('auth/coursepayment/', CoursePaymentIndexView.as_view(), name='coursepayment_index'),
    path('auth/coursepayment/<int:course>/', CoursePaymentDetailView.as_view(), name='coursepayment_detail'),
    path('auth/coursepayment/<int:course>/export/csv', CoursePaymentExportCsv.as_view(), name='coursepayment_export_csv'),
    path('auth/coursepayment/<int:course>/export/vcard', CoursePaymentExportVCard.as_view(), name='coursepayment_export_vcard'),
    path('auth/coursepayment/<int:course>/export/', CoursePaymentExportExcel.as_view(), name='coursepayment_export'),
    path('auth/coursepayment/<int:course>/<usi:usi>/', CoursePaymentConfirm.as_view(), name='coursepayment_confirm'),
    path('auth/coursepayment/<int:course>/<usi:usi>/paid/', CoursePaymentConfirm.as_view(), name='coursepayment_paid'),
