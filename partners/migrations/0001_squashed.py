...
class Migration(migrations.Migration):
    ...
    replaces = [('partners', '0001_initial'), ('partners', '0002_partner_active'), ('partners', '0003_alter_partner_image')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=partners.models.partner.upload_path, verbose_name='Image')),
                ('url', models.URLField()),
