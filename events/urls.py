...
urlpatterns = [
    ...
    path('<int:event_id>/confirmation/', views.registration_confirmation, name='registration_confirmation'),
    path('<int:event_id>/unregistered/', views.registration_removed, name='registration_removed'),
