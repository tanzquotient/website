...
# Finance
S3_FINANCE_BUCKET = environ['TQ_S3_POSTFINANCE_BUCKET']
S3_FINANCE_HOST = environ['TQ_S3_POSTFINANCE_HOST']
S3_FINANCE_PORT = environ['TQ_S3_POSTFINANCE_PORT']
S3_FINANCE_REGION = environ['TQ_S3_POSTFINANCE_REGION']
S3_FINANCE_USE_SSL = bool(environ["TQ_S3_POSTFINANCE_USE_SSL"].lower() == 'true')
S3_FINANCE_CUSTOM_DOMAIN = environ['TQ_S3_POSTFINANCE_CUSTOM_DOMAIN']
S3_FINANCE_ACCESS_KEY = environ['TQ_S3_POSTFINANCE_ACCESS_KEY']
S3_FINANCE_SECRET_KEY = environ['TQ_S3_POSTFINANCE_SECRET_KEY']
