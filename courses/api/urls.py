...
payment_urls = [
    path('course/<int:pk>/', CoursePaymentDetail.as_view(), name='course-payment-detail'),
    path('subscription/<int:pk>/', SubscriptionPayment.as_view(), name='subscription-payment'),
]
