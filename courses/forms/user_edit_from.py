...
class UserEditForm(forms.Form):
    ...
    phone_number.help_text = 'Deine Nummer wird nur für interne Zwecke verwendet und den Lehrern ' \
    ...
    body_height.help_text = 'Die Körpergrösse (in cm) kann bei Einzelanmeldungen angegeben werden ' \
