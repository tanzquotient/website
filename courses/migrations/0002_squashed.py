...
class Migration(migrations.Migration):
    ...
    replaces = [('courses', '0002_auto_20200215_1336'), ('courses', '0003_auto_20200219_1613'), ('courses', '0004_auto_20200227_1031'), ('courses', '0005_auto_20200331_1936'), ('courses', '0006_auto_20200401_1236'), ('courses', '0007_auto_20200413_1829'), ('courses', '0008_userprofile_language'), ('courses', '0009_auto_20200426_1526'), ('courses', '0010_added_sql_views'), ('courses', '0011_modified_sql_views'), ('courses', '0012_auto_20211027_1712'), ('courses', '0013_alter_userprofile_picture'), ('courses', '0014_auto_20220403_1300'), ('courses', '0015_auto_20220403_2158'), ('courses', '0016_alter_subscribe_usi'), ('courses', '0017_auto_20220419_1022'), ('courses', '0018_auto_20221027_2227'), ('courses', '0019_alter_musicpluginmodel_cmsplugin_ptr'), ('courses', '0020_alter_subscribe_paymentmethod')]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='subscribe',
            name='usi',
            field=models.CharField(blank=True, default=utils.code_generator.CodeGenerator.short_uuid_without_ambiguous_characters, help_text='Unique subscription identifier: Randomly generated', max_length=6, unique=True),
        ),
        migrations.AlterField(
            model_name='subscribe',
            name='state',
            field=models.CharField(choices=[('new', 'new'), ('confirmed', 'confirmed (to pay)'), ('payed', 'paid'), ('completed', 'completed'), ('rejected', 'rejected'), ('to_reimburse', 'to reimburse')], db_index=True, default='new', max_length=30),
        ),
        migrations.AlterField(
            model_name='userprofile',
            name='gender',
